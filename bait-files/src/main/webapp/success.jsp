...
<html>
  ...
  <body>
    <span id="checkmark" class="iconify" data-icon="mdi:check-circle-outline" data-inline="false" style="color: #a5d6a7;" alt="Green checkmark with circle around it"></span>
    <h1>Thank You!</h1>
