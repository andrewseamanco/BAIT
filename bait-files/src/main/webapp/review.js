...
function getRequest() {
  ...
  fetch('/request' + queryString)
    ...
    function addRequestToPage(request) {
      ...
      addTextToPage(
          ADDRESS_INPUT, 'Country Code: ' + request.address.countryCode);
      addTextToPage(
    ...
    function addPhoneResultsToPage(results) {
      ...
      addTextToPage(
          PHONE_RESULTS, 'country code: ' + results.country_calling_code);
    ...
    function addEmailResultsToPage(results) {
      ...
      addTextToPage(
          EMAIL_RESULTS, 'is autogenerated: ' + results.is_autogenerated);
