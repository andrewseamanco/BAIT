...
public final class FindMeetingQueryTest {
  ...
  public void justEnoughRoomForMandatory() {
    // Have an optional member who has a 15 minute meeting is too long for the single available
    // time during the day to be filled.  Return the spot that fulfills the mandatory request.
    //
    // Events  : |--A--|     |----A----|
    //                 |-O-|
    // Day     : |---------------------|
